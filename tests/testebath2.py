...
print "initialise md"
print md.__doc__
test = md(dt,nmd,T,harmonic=True,dyn=eph.DynMat,nrep=8)
...
fk = open("kappa."+str(T)+"."+str(eV)+".noxim.dat","w")
...
#output
#---------------------------------------------------------------------------------
f = open("power."+str(T)+"."+str(eV)+".noxim.dat","w")
...
f.close()
#---------------------------------------------------------------------------------
f = open("energy."+str(T)+"."+str(eV)+".noxim.dat","w")
for i in range(test.nmd):
    f.write("%f     %f \n"%(i,test.etot[i]))
f.close()
#------------------------------------------------------------------------------
