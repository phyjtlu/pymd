/*
 * This file automatically produced by /applications/Mathematica/7.0/SystemFiles/Links/MathLink/DeveloperKit/Linux-x86-64/CompilerAdditions/mprep from:
 *	Brenner.tm
...
void Brenner P(( int _tp1, double * _tp2, long _tpl2, double * _tp3, long _tpl3));
...
#endif
{
	...
	Brenner(_tp1, _tp2, _tpl2, _tp3, _tpl3);
...
#endif
{
	int _res;
	_res = MLConnect(mlp);
	if (_res) _res = _definepattern(mlp, "Brenner[na_Integer, R_List, uc_List]", "{na,R,uc}", 0);
