function dump0 = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   DUMP0 = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   DUMP0 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   dump0 = importfile('dump0.xyz', 3, 8);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/11/20 19:58:22
