...
if __name__ == '__main__':
    ...
    infile = ['atom_style full',
              ...
              'region reg_0   block      0.0    4.0          INF INF INF INF    units box',
              'region reg_7   block      44.0   48.2599983   INF INF INF INF    units box',
